...
cljs.core._with_meta["function"] = function(a, b) {
  return cljs.core.with_meta.call(null, function() {
    if(void 0 === cljs.core.t4083) {
      cljs.core.t4083 = {};
      cljs.core.t4083 = function(a, b, c) {
        this.meta = a;
        this.f = b;
        this.meta4084 = c;
      ...
      cljs.core.t4083.cljs$lang$type = !0;
      cljs.core.t4083.cljs$lang$ctorPrSeq = function() {
        return cljs.core.list.call(null, "cljs.core/t4083")
      };
      cljs.core.t4083.cljs$lang$ctorPrWriter = function(a, b) {
        return cljs.core._write.call(null, b, "cljs.core/t4083")
      };
      var c = cljs.core.t4083.prototype, d = function(a, b) {
      ...
      c.call = e;
      cljs.core.t4083.prototype.apply = function(a, b) {
        a = this;
        return a.call.apply(a, [a].concat(b.slice()))
      };
      cljs.core.t4083.prototype.cljs$core$Fn$ = !0;
      cljs.core.t4083.prototype.cljs$core$IMeta$_meta$arity$1 = function() {
        return this.meta4084
      };
      cljs.core.t4083.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(a, b) {
        return new cljs.core.t4083(this.meta, this.f, b)
      }
    }
    return new cljs.core.t4083(b, a, null)
  }(), b)
};
...
var layout = {core:{}};
layout.core.parse_ajax_result = function(a) {
  var b = a.status, c;
  try {
    c = cljstang.json.parse.call(null, a.responseText)
  }catch(d) {
    if(cljs.core.instance_QMARK_.call(null, Object, d)) {
      c = null
    }else {
      throw d;
    }
  ...
  return cljs.core.ObjMap.fromObject(["\ufdd0:status", "\ufdd0:result", "\ufdd0:success?"], {"\ufdd0:status":b, "\ufdd0:result":c, "\ufdd0:success?":a})
};
layout.core.request_from_local_QMARK_ = function() {
  return cljs.core.not_EQ_.call(null, -1, location.href.indexOf("localhost"))
};
layout.core.trace = function() {
...
layout.core.ajax_complete = function() {
  var a = function(a, b, e, f) {
    f = cljs.core.nth.call(null, f, 0, null);
    if(cljs.core.not.call(null, cljstang.core.ends_with.call(null, e.url, "/polling"))) {
      var g = layout.core.parse_ajax_result.call(null, b), h = cljs.core.seq_QMARK_.call(null, g) ? cljs.core.apply.call(null, cljs.core.hash_map, g) : g, i = cljs.core._lookup.call(null, h, "\ufdd0:success?", null), g = cljs.core._lookup.call(null, h, "\ufdd0:result", null);
      cljs.core._lookup.call(null, h, "\ufdd0:status", null);
      h = [cljs.core.str("\u64cd\u4f5c"), cljs.core.str(cljs.core.truth_(i) ? "\u6210\u529f! " : "\u5931\u8d25! ")].join("");
      $.pnotify({title:h, text:g.message, type:g.type})
    }
    return cljs.core.truth_(layout.core.request_from_local_QMARK_.call(null)) ? layout.core.trace.call(null, a, b, e, f) : null
  }, b = function(b, d, e, f) {
    var g = null;
    goog.isDef(f) && (g = cljs.core.array_seq(Array.prototype.slice.call(arguments, 3), 0));
    return a.call(this, b, d, e, g)
...
$(document).ajaxComplete(function(a, b, c) {
  ...
  return layout.core.ajax_complete.call(null, a, b, c)
});
$(document).ajaxSend(function() {
  return jayq.core.show.call(null, jayq.core.$.call(null, "\ufdd0:#ajax-preload"))
});
layout.util = {};
layout.util.moment_format = function() {
  return wappjs.momentFormat()
};
goog.exportSymbol("layout.util.moment_format", layout.util.moment_format);
var app = {ui:{}};
app.ui.controllers = {};
app.ui.controllers.ClientMomentTimeCtrl = function(a, b) {
  a.moment = layout.util.moment_format.call(null);
  return a.$watch("moment", function() {
    return b.call(null, function() {
      return a.moment = layout.util.moment_format.call(null)
    }, 2E3)
  })
};
app.ui.controllers.ClientMomentTimeCtrl.$inject = ["$scope", "$timeout"];
layout.main = {};
layout.main.text_from = function(a) {
  var b = a.lastIndexOf(">");
  return a.substring(b + 1)
};
layout.main.highlight_current_location = function() {
  for(var a = location.href, b = [cljs.core.str("#sidebar #navigation > ul > li"), cljs.core.str(" > ul > li")].join(""), c = [cljs.core.str(b), cljs.core.str(" > a")].join(""), d = jayq.core.$.call(null, c), e = cljs.core.count.call(null, d), f = 0;;) {
    if(f < e) {
      ...
      if(cljs.core.truth_(cljstang.core.ends_with.call(null, a, g))) {
        a = jayq.core.parent.call(null, jayq.core.parent.call(null, jayq.core.parent.call(null, c))), d = jayq.core.inner.call(null, c), e = jayq.core.$.call(null, "head title"), f = jayq.core.inner.call(null, e), jayq.core.remove_class.call(null, jayq.core.$.call(null, [cljs.core.str(b), cljs.core.str(".active")].join("")), "active"), jayq.core.attr.call(null, jayq.core.parent.call(null, c), "class", "active"), jayq.core.remove_class.call(null, jayq.core.$.call(null, [cljs.core.str("#sidebar #navigation > ul > li"), 
        cljs.core.str(".active")].join("")), "active"), jayq.core.attr.call(null, a, "class", "active"), jayq.core.inner.call(null, jayq.core.$.call(null, "#main-header .sub-menu"), d), jayq.core.inner.call(null, e, [cljs.core.str(layout.main.text_from.call(null, d)), cljs.core.str(" - "), cljs.core.str(f)].join(""))
      }else {
        f += 1;
        continue
      }
...
layout.main.init = function() {
  return layout.main.highlight_current_location.call(null)
};
goog.exportSymbol("layout.main.init", layout.main.init);
app.ui.apps = {};
app.ui.apps.wapp = function() {
...
app.ui.apps.wapp.controller("ClientMomentTimeCtrl", app.ui.controllers.ClientMomentTimeCtrl);
