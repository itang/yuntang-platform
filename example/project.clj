(defproject yuntang-platform/example "0.1.0-SNAPSHOT"
  ...
  :profiles {:dev {:plugins [[lein-outdated "1.0.0"] ;$ lein outdated => newer available versions of dependencies
                             [codox "0.6.4"]         ;$ lein doc
                             [lein-ring "0.8.5"]     ;$ lein ring server
